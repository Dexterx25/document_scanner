...
import Logo from '../../imgs/FanatikaLogoNew.jpg';
...
class ImageSlider extends Component {
  ...
  state = {
    photos: [
      {
        image: loginImage1,
        textFirst:  "Mensajes y videos personalizados mercancia autentica y autografiada \n de tus celebridades favoritas",
      },
      {
        image: loginImage2,
        textFirst: "un porcentaje de las ganancias recaudadas siempre son donadas a obras sociales escogidas por las celebridades",
      },
      {
        image: loginImage3,
        textFirst: "Vive una experiencia inolvidable",
      }
    ]
  }
